...
export default function App() {
  return (
    ...
    <NavigationContainer>
          <Drawer.Navigator initialRouteName="Home"  drawerContent={props => <CustomDrawer {...props} />} screenOptions={{ headerShown: false,  drawerLabelStyle:  {marginLeft: -18, fontSize: 16, fontFamily: 'Roboto', padding: 10}, drawerActiveBackgroundColor: '#D8D8D8', drawerActiveTintColor: '#176EBB'}}>
